...
```
cd existing_repo
git remote add origin https://gitlab.com/lewroy/rabbitmq-test.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/lewroy/rabbitmq-test/-/settings/integrations)
